    ...
    <main>
        <form id="form1" runat="server" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <asp:DataList ID="dlLineItems" runat="server" CssClass="col-xs-12 col-sm-offset-1 col-sm-9 table-bordered table-condensed" DataSourceID="SqlDataSource2" style="left: 0px; top: 0px; width: 835px">
                    <HeaderTemplate>
                        <span class="col-xs-3">Product ID</span>
                        <span class="col-xs-3 text-right">Unit Price </span>
                        <span class="col-xs-3 text-right">Quantity </span>
                        <span class="col-xs-3">Extension </span>
                    </HeaderTemplate>
                    <ItemTemplate>
                        ...
                        <asp:Label ID="ExtensionLabel" runat="server" Text='<%# Eval("Extension", "{0:C}") %>' CssClass="col-xs-3"/>
                    </ItemTemplate>
